...
![image-20201102172217820](E:\BaiduSyncdisk\路飞学城Python全栈开发（中级）\官网-笔记\第一模块 Python集成（V2.0版）\assets\image-20201102172217820.png)
...
<img src="E:\BaiduSyncdisk\路飞学城Python全栈开发（中级）\官网-笔记\第一模块 Python集成（V2.0版）\assets\image-20201102190227431.png" alt="image-20201102190227431" style="zoom:50%;" />
...
7. 有变量name = "aleX leNb " 完成如下操作： 
   ...
   - 移除 name 变量对应的值两边的空格,并输出处理结果    print(name.strip())
   - 判断 name 变量是否以 "al" 开头,并输出结果（用切片 或 startswith实现） print(name.startswith('al'))
   - 判断name变量是否以"Nb"结尾,并输出结果（用切片 或 endswith实现）  print(name.endswith('Nb'))
   - 将 name 变量对应的值中的 所有的"l" 替换为 "p",并输出结果    print(name.replace('I','p'))
   - 将 name 变量对应的值根据 所有的"l" 分割,并输出结果    print(name.split('I'))
   - 将name变量对应的值根据第一个"l"分割,并输出结果      print(name.split('I',1))
   - 将 name 变量对应的值变大写,并输出结果   print(name.upper())
...
<img src="E:\BaiduSyncdisk\路飞学城Python全栈开发（中级）\官网-笔记\第一模块 Python集成（V2.0版）\assets\image-20201120193837492.png" alt="image-20201120193837492" style="zoom:50%;" />

#### 1.5.2 元素必须可哈希

因存储原理，集合的元素必须是可哈希的值，即：内部通过通过哈希函数把值转换成一个数字。

<img src="E:\BaiduSyncdisk\路飞学城Python全栈开发（中级）\官网-笔记\第一模块 Python集成（V2.0版）\assets\image-20201120190454120.png" alt="image-20201120190454120" style="zoom: 25%;" />
...
![image-20201121131221807](E:\BaiduSyncdisk\路飞学城Python全栈开发（中级）\官网-笔记\第一模块 Python集成（V2.0版）\assets\image-20201121131221807.png)
...
- 浮点型的坑（所有语言中）
  <img src="E:\BaiduSyncdisk\路飞学城Python全栈开发（中级）\官网-笔记\第一模块 Python集成（V2.0版）\assets\image-20201121190846593.png" alt="image-20201121190846593" style="zoom: 33%;" />
