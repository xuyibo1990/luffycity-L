...
参考文档：https://www.cnblogs.com/wupeiqi/articles/5484747.html
...
```python
tpl1 = "percent %.2f" % 99.97623
print(tpl1)  # percent 99.98
tpl2 = "percent %(num).2f %%" % {'num':99.97623}
print(tpl2)  # percent 99.98 %
tpl3 = "percent %(num).2f %(age)d %%" % {'num':99.97623,'age':18}
print(tpl3)  # percent 99.98 18 %

tpl4 = "percent %+10.2f" % 99.97623
print(tpl4,tpl4)  # percent     +99.98 percent     +99.98
tpl5 = "percent %010.2f" % 99.97623
print(tpl5,tpl5)  # percent 0000099.98 percent 0000099.98
```
...
```python
tpl='{:>20,.2%}'.format(3000104.1)
print(tpl) #      300,010,410.00%
```
...
- 算数运算符，例如：加减乘除
  <img src="E:\BaiduSyncdisk\路飞学城Python全栈开发（中级）\官网-笔记\第一模块 Python集成（V2.0版）\assets\image-20201011165419956.png" alt="image-20201011165419956"  />
...
- 比较运算符，例如：大于、小于
  <img src="E:\BaiduSyncdisk\路飞学城Python全栈开发（中级）\官网-笔记\第一模块 Python集成（V2.0版）\assets\image-20201011165434014.png" alt="image-20201011165434014"  />
...
- 赋值运算，例如：变量赋值
  <img src="E:\BaiduSyncdisk\路飞学城Python全栈开发（中级）\官网-笔记\第一模块 Python集成（V2.0版）\assets\image-20201011165501909.png" alt="image-20201011165501909"  />
...
- 成员运算，例如：是否包含
  <img src="E:\BaiduSyncdisk\路飞学城Python全栈开发（中级）\官网-笔记\第一模块 Python集成（V2.0版）\assets\image-20201011165515812.png" alt="image-20201011165515812"  />
...
- 逻辑运算，例如：且或非
  <img src="E:\BaiduSyncdisk\路飞学城Python全栈开发（中级）\官网-笔记\第一模块 Python集成（V2.0版）\assets\image-20201011165530169.png" alt="image-20201011165530169"  />
