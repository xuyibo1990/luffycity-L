...
![image-20201216175307239](E:\BaiduSyncdisk\路飞学城Python全栈开发（中级）\官网-笔记\第二模块 函数和模块（V2.0版）\assets\image-20201216175307239.png)
...
- 路径
  ...
  - 相对路径，你的程序到底在哪里运行的？
    ...
    ![image-20201217140130973](E:\BaiduSyncdisk\路飞学城Python全栈开发（中级）\官网-笔记\第二模块 函数和模块（V2.0版）\assets\image-20201217140130973.png)


    ![image-20201217140237160](E:\BaiduSyncdisk\路飞学城Python全栈开发（中级）\官网-笔记\第二模块 函数和模块（V2.0版）\assets\image-20201217140237160.png)
...
>   ```
>
>   ![image-20201217152358142](E:\BaiduSyncdisk\路飞学城Python全栈开发（中级）\官网-笔记\第二模块 函数和模块（V2.0版）\assets\image-20201217152358142.png)
>
> - 使用第三方模块
>
>   ```python
...
- 检查、删除、添加节点
  ...
  **[ 补充]**
  ...
  def createconfig():
      # 方法一
      config['a'] = {'a1': 1, 'a2': 2, 'a3': '3', 'a4': 'true'}
  ...
  # 查询配置文件
  def selectconfig():
      config.read('example.ini', encoding='utf-8')  # 返回['example.ini']
      print(config.sections())  # ['a', 'b', 'c']
      print(config.options('a'))  # ['a1', 'a2', 'a3', 'a4']
      print(config.items('a'))  # [('a1', '1'), ('a2', '2'), ('a3', '3'), ('a4', 'true')]
      print(config.get('a', 'a1')) # 1
      print(config.getint('a', 'a1')) # 1
      print(config.getfloat('a', 'a1')) # 1.0
      print(config.getboolean('a', 'a4')) # True
  ...
  def editconfig():
      ...
      config.remove_option('b', 'b1')
  
      # 判断是否存在section 或 option
      print(config.has_section('c'))
      print(config.has_option('a', 'a1'))
...
![image-20201218012118097](E:\BaiduSyncdisk\路飞学城Python全栈开发（中级）\官网-笔记\第二模块 函数和模块（V2.0版）\assets\image-20201218012118097.png)
...
- 读合并的单元格
  ...
  ![image-20201218011732755](E:\BaiduSyncdisk\路飞学城Python全栈开发（中级）\官网-笔记\第二模块 函数和模块（V2.0版）\assets\image-20201218011732755.png)
...
3. 读取ini文件内容，按照规则写入到Excel中。
   ...
   - 读取ini格式的文件，并创建一个excel文件，且为每个节点创建一个sheet，然后将节点下的键值写入到excel中，按照如下格式。
     <img src="E:\BaiduSyncdisk\路飞学城Python全栈开发（中级）\官网-笔记\第二模块 函数和模块（V2.0版）\assets\image-20201218204922898.png" alt="image-20201218204922898" style="zoom: 33%;" />
